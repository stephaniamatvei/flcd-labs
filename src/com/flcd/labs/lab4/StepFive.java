...
public class StepFive extends StepFour {
    ...
    public StepFive(File grammarInput) throws FileNotFoundException {
        super(grammarInput);
    }
    ...
    // add terminal rules and replace those having 1 terminal and 1 non-terminal on the right side (S -> aB)
